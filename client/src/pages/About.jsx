    ...
    <Container>
      ...
      <div className="about" style={{ marginBottom: "100px" }}>
        ...
        <p>
          ...
          and engage with relevant information about each charity organization
          by giving them a platform where they can easily search information
          about organizations and narrow down the charities they would like to
          contribute to.
        </p>
        <p>
          <p>
        ...
        <p>
          Shania Dhani:{" "}
          <a href="https://github.com/sdhani">https://github.com/sdhani</a>
        </p>
        <p>
          Xing Tao Shi:{" "}
          <a href="https://github.com/xshi0603">https://github.com/xshi0603</a>
        </p>
        <p>
          Darren Liang:{" "}
          <a href="https://github.com/dliang2">https://github.com/dliang2</a>
        </p>
        <p>
          Jessica Wong:{" "}
          <a href="https://github.com/wongjessica">
            https://github.com/wongjessica
          </a>
        </p>
      </div>
    </Container>
